...
3. **Environment Configuration**
   ...
   <Aside type="tip" title="Secrets Management Guide">
     See the complete [Secrets Management Guide](/guides/how-to/secrets-management/) for detailed information about setting up `.env` files for different environments.
   </Aside>
